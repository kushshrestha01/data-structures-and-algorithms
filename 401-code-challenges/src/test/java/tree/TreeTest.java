...
public class TreeTest {
    ...
    public void testTreeInOrder() {
        ...
        ArrayList<Integer> expectedOutput = new ArrayList<Integer>();
        expectedOutput.add(1);expectedOutput.add(3);expectedOutput.add(6);
        expectedOutput.add(8);expectedOutput.add(10);expectedOutput.add(14);
    ...
    public void testTreePostOrder() {
        ...
        ArrayList<Integer> expectedOutput = new ArrayList<Integer>();
        expectedOutput.add(1);expectedOutput.add(6);expectedOutput.add(3);
